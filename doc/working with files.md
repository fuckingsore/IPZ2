...
Сьогодні ми поговоримо про роботу з файлами в `Node.js`. Зокрема, мова піде про модулі `fs`, `fs-extra`, `path`  і `glob` - про файлові дескриптори, про шляхи до файлів, про отримання інформації про файли, про їх читання і запис, про роботу з директоріями і так далі.
